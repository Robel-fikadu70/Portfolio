...
const Tooltip = ({techStack}) => {
  return (
    <div className="relative inline-block group">
      ...
      <div className="absolute invisible opacity-0 group-hover:visible group-hover:opacity-100 bottom-full left-1/2 -translate-x-1/2 mb-3 w-100 transition-all duration-300 ease-out transform group-hover:translate-y-0 translate-y-2">
        <div className="relative p-4 bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-md rounded-2xl border border-white/10 shadow-[0_0_30px_rgba(79,70,229,0.15)]">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-400">
              ...
              <span>Only main Techstacks are mentioned</span>
            </div>
          </div>
