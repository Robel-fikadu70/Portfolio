...
const icons = [
  ...
  { id: 5, src: '/assets/icons8-tailwind-css-96.svg', label: 'tailwind' },
  { id: 6, src: '/assets/icons8-python-100.svg', label: 'python' },
  { id: 7, src: '/assets/icons8-python-50.svg', label: 'python' },
  { id: 8, src: '/assets/icons8-postgresql-96.svg', label: 'postgresql' },
  { id: 9, src: '/assets/icons8-nodejs-96.svg', label: 'nodejs' },
  { id: 10, src: '/assets/icons8-nextjs-96.svg', label: 'nextjs' },
  { id: 11, src: '/assets/icons8-mongodb-96.svg', label: 'mongodb' },
  { id: 12, src: '/assets/icons8-javascript-100.svg', label: 'javascript' },
  { id: 13, src: '/assets/icons8-express-js-100.svg', label: 'express-js'},
